...
#         )
#         cls.serializer_data = {
#             "recipient_id": contact.pk,
#             "recipient_info": "luke@example.com",
#             "text": "Join me",
#             "subject": "I am your father",
#             "conversation_id": cls.conversation.pk,
...
#             mock.patch(
#                 "send_mail.serializers.Reservation.objects.filter",
...
#         )
#         self.assesetTrue(ser.is_valid(), ser.errors)
...
#
#
# class APIMessageSerializerTestCase(MessageSerializerTestCase):
#
...
#
# class MailSerializerTest(TestCase):
#     def test_subject_is_required(self):
#         for data in [{"subject": ""}, {"subject": None}]:
#             serializer = serializers.MailSerializer(data=data, partial=True)
...
class MailViewTestCase(TestCase):
    ...
    def test_get_serializer(self):
        ...
        with self.subTest("Use AirbnbMessageSerializer"):
            ...
            self.assertIs(view.get_serializer_class(), serializers.APIMessageSeralizer)
